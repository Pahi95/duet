...
Usage: python evaluate_sim.py --results-dir results_sim --h5ad data/sim_muscat.h5ad
"""
...
def main():
    ...
    ap.add_argument("--results-dir", default=str(HERE / "results_sim"))
    ap.add_argument("--h5ad", default=str(HERE / "data" / "sim_muscat.h5ad"))
